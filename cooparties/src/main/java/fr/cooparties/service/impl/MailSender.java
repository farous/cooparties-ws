...
public class MailSender {
	...
	public static void main(String[] args) {
		try {
			MailSender.send("cooparties@gmail.com", "santeclair", "destinataire@destinataire.com", "titre du message", "voici un message");
	...
	public static void send(final String username, final String password, String recipientEmail, String title, String message) throws AddressException, MessagingException {
		MailSender.send(username, password, recipientEmail, "", title, message);
	}
	...
	public static void send(final String username, final String password, String recipientEmail, String ccEmail, String title, String message) throws AddressException, MessagingException {
		...
		msg.setFrom(new InternetAddress("momo99@yahoo.fr"));
